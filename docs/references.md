...
For the full bibliography, related heterogeneous-boosting literature (KTBoost, DeepBoost, etc.), and notes on how this repo relates to the original IBM Snap ML implementation, see [REFERENCES.md](https://github.com/qiancapital/snapboost/blob/main/REFERENCES.md) in the repository. Additional BibTeX entries are in [CITATION.bib](https://github.com/qiancapital/snapboost/blob/main/CITATION.bib).
